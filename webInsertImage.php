...
<html>
	...
	<head>
		...
		<script type='text/javascript' src='./js/ajxInsertImage.js'></script>
	...
	<body>
		...
		<div class='wrapper'>
			...
			<section>
				<label for="uploadImage" class="label-Image">Choisir une image ...</label>
				<input id="uploadImage" class="input-Image" type="file">
				
				<input class='title'type='text' name='title' placeholder='Titre de image' autofocus />
				...
				<button class="btnSend" id='uploadImage'>Envoyer</button>
