...
<html>
	...
	<head>
		...
		<script type='text/javascript' src='./js/ajxUpdateLink.js'></script>
		<script type='text/javascript' src='./js/ajxDeleteLink.js'></script>
	...
	<body>
		...
		<div class='wrapper'>
			...
			<section>
				<?php
					echo "<input class='idLink' type='hidden' name='idLink' value='" . $idLink . "' />";
					...
					// Query : select
					$query = "SELECT title, content, borderColor, size FROM tblLinks WHERE id = $idLink;";
